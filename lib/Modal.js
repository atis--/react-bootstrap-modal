  ...
  Modal.prototype.componentDidMount = function componentDidMount() {
    ...
    getZIndex = function () {
      ...
      return function (type) {
        return baseIndex[type] + zIndexFactor * (_this2.manager.modals.length - 1);
      };
    }();
  };
    ...
    return _react2.default.createElement(
      _Modal2.default,
      {
        ...
        ref: function ref(_ref) {
          _this3.modal = _ref && _ref.refs.modal;
          _this3.backdrop = _ref && _ref.refs.backdrop;
          _this3.manager = _ref && _ref.props.manager;
        },
        container: container,
